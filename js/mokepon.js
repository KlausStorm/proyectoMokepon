...
class Mokepon {
    constructor(nombre, foto, vida, defensa, neutral, efectivo, noefectivo,  tipo, fotoMapa){
        this.nombre = nombre
        this.foto = foto
        this.vida = vida
...
const aquaflareEnemigo = new Mokepon("aquaflare", "./assets/fotor-ai-20240520191929.jpg", 80, 0.09, Math.ceil(11.64), Math.ceil(37.7), Math.ceil(7.6), "agua", "./assets/fotor-ai-20240520191929.jpg")
const blazewindEnemigo = new Mokepon("blazewind", "./assets/fotor-ai-20240520192050.jpg", 90, 0.08, Math.ceil(11.64), Math.ceil(37.7), Math.ceil(7.6), "fuego","./assets/fotor-ai-20240520192050.jpg")
const terraclodEnemigo = new Mokepon("terraclod", "./assets/terraclod.png", 120, 0.05, Math.ceil(11.64), Math.ceil(37.7), Math.ceil(7.6), "tierra", "./assets/terraclod.png")
const gustflareEnemigo = new Mokepon("gustflare", "./assets/gustflare.png", 80, 0.09, Math.ceil(11.64), Math.ceil(37.7), Math.ceil(7.6), "viento", "./assets/gustflare.png")
const frostglintEnemigo = new Mokepon("frostglint", "./assets/frostglint.png", 100, 0.07, Math.ceil(11.64), Math.ceil(37.7), Math.ceil(7.6), "hielo", "./assets/frostglint.png")
...
function printCanvas(){
    ...
    aquaflareEnemigo.printMokepon()
    blazewindEnemigo.printMokepon()
    terraclodEnemigo.printMokepon()
    gustflareEnemigo.printMokepon()
    frostglintEnemigo.printMokepon()
    if(mokeponChoosen.speedX !== 0 || mokeponChoosen.speedY !== 0){
        revisarColision(aquaflareEnemigo)
        revisarColision(blazewindEnemigo)
        revisarColision(terraclodEnemigo)
        revisarColision(gustflareEnemigo)
        revisarColision(frostglintEnemigo)
    }
}
